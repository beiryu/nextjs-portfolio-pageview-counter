						...
						<div className="border-l-2 border-zinc-700 pl-6">
							...
							<ul className="mt-4 text-zinc-400 list-disc list-inside space-y-2">
								<li>
									...
									delivering high-level solutions including custom APIs,
							...
							<ul className="text-zinc-400 list-decimal list-inside space-y-2">
								...
								<li>
									Served as primary owner for key microservices within the game
									ecosystem, including social network (profile, friend, clan,
									habitat services), combat system (PvP/PvE/matchmaking
									services)
								</li>
								<li>
								...
								<li>
									...
									<ul className="pl-10 mt-2 space-y-1 list-[lower-alpha]">
										...
										<li>
											...
											<ul className="pl-6 mt-2 space-y-1 list-disc">
												<li>
													Architected and implemented core social features
													including profiles, friend systems, clan management,
													and player habitats
												</li>
												<li>
													Developed an advanced friend recommendation engine
													using graph algorithms and player behavior analysis
												</li>
												<li>
													Built real-time clan chat and activity feeds using
													WebSocket connections and Redis pub/sub
												</li>
												<li>
													Created habitat customization system with real-time
													synchronization between players
												</li>
												<li>
													Implemented social achievements and rewards system
										...
										<li>
											...
											<ul className="pl-6 mt-2 space-y-1 list-disc">
												<li>
													Designed and implemented PvP matchmaking algorithm
													considering player rank, level, and historical
													performance
												</li>
												<li>
													Built PvE progression system with dynamic difficulty
													scaling based on player stats
												</li>
												<li>
													Created combat result validation and anti-cheat
													systems to ensure fair play
												</li>
												<li>
						...
						<div className="border-l-2 border-zinc-700 pl-6">
							...
							<ul className="mt-4 text-zinc-400 list-disc list-inside space-y-2">
								<li>
									...
									user management, group management, payment processing, and
									other core system functionalities.
								</li>
								<li>
									Maintain and enhance frontend admin panel and dashboard using
									React, ensuring intuitive user experience and responsive
									design.
								</li>
								<li>
									Package and deploy microservices to Google Cloud Platform
									(GCP), managing containerization and orchestration processes.
								</li>
								<li>
									Conduct code reviews and provide technical guidance to ensure
									code quality, best practices, and maintainability across the
									codebase.
								</li>
								<li>
									Implement and optimize caching strategies using Redis to
									improve application performance and reduce database load.
								</li>
								<li>
									Manage deployments across Google Cloud and AWS infrastructure,
							...
							<div className="mt-4 text-zinc-400">
								<strong>Tech Stack:</strong> Node.js, React, Redis, Google Cloud
								Platform, AWS, Microservices Architecture
							</div>
						</div>
						...
						<div className="border-l-2 border-zinc-700 pl-6">
							...
							<ul className="mt-4 text-zinc-400 list-disc list-inside space-y-2">
								<li>
									...
									clients across various industries and use cases.
								</li>
								<li>
									Deliver end-to-end full-stack solutions from initial concept
									to production-ready applications.
								</li>
								<li>
									Work closely with clients to understand requirements, provide
									technical consultation, and deliver solutions that meet
									business objectives.
								</li>
								<li>
									Rapidly prototype and iterate on features to validate ideas
									and accelerate time-to-market.
								</li>
								<li>
									Ensure code quality, scalability, and maintainability while
									meeting tight deadlines for MVP delivery.
								</li>
							</ul>
							<div className="mt-4 text-zinc-400">
								<strong>Tech Stack:</strong> React, Node.js, MongoDB, Express,
								TypeScript, Docker, Kubernetes, AWS, GCP.
							</div>
						</div>
						...
						<div>
							<ul className="mt-2 list-disc list-inside">
								<li>
									<Link
										href={
											"https://certificate.agilearn.app/view?id=SrIIN4jz8IvQvGgtOApP&display_name=%C4%90inhNguy%C3%AAnKh%C3%A1nh&course_name=scrumessence2.0"
										}
										className="underline underline-offset-4 duration-200 text-zinc-400 hover:text-zinc-100"
									>
										Scrum Essence 2.0, Agile Academy, March 2025
									</Link>
								</li>
							</ul>
						</div>
